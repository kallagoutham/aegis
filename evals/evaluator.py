...
# Langfuse moved this type out of its public surface in v4. It was only ever
# used as an annotation here, so alias it rather than importing a vendor
# internal path that breaks on every minor upgrade.
TraceWithDetails = Any
...
class Evaluator:
    ...
    def __init__(self):
        ...
        self.client = openai.AsyncOpenAI(
            api_key=settings.EVALUATION_API_KEY.get_secret_value(), base_url=settings.EVALUATION_BASE_URL
        )
